  ...
  return (
    <div className="App">
      ...
      <div className="content">
        ...
        <div className='hidden md:flex items-center mt-24 justify-evenly'>
        ...
        <div>
          <img className='w-96 h-72' src={Nike} alt="Nike" />
        </div>
        <p className='relative w-80 text-center font-semibold z-10 ml-auto mr-auto'>“This pair, which is ostensibly exclusive to the Swoosh’s younger audience, is helmed by “Dark Powder Blue,” the same color that has dressed many a notable release of the Air Jordan 1 in the past. Here, the cool tone marks the Bruce Kilgore-designed classic’s overlays, while black neutrals outfit the Swoosh, outsole, and the “AIR” across the midsole. The rest of the latter fixture is done up in white, matching the base of the upper as well as the tongue, lining, and adjacent branding.”</p>
        <p className='relative w-80 text-center font-semibold z-10 ml-auto mr-auto mt-8'>As we delve further into the details of this release, we can observe that the rest of the midsole is done up in pristine white, beautifully matching the base of the upper as well as the tongue, lining, and adjacent branding elements. This combination of colors and materials creates a dynamic and stylish look that captures the essence of youthful energy and timeless design.</p>
        </div>
